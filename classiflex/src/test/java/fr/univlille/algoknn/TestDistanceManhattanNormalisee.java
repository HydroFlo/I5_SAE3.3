...
class TestDistanceManhattanNormalisee {
    ...
    void test_Distance_with_Different_Values() {
        ...
        // Normalisation et calcul de la distance Manhattan.

        double result = distanceManhattanNormalisee.distance(iris1, iris2, caracs);
        // Vérifiez la distance attendue après normalisation
        assertTrue(result >= 0); // On s'assure que la distance est positive
    }
